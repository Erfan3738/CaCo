...
def main_worker(args):
    ...
    if args.dataset=='stl10':
        ...
        normalize = transforms.Normalize(mean=[0.4465, 0.4402, 0.4039],
                                     std=[0.2608, 0.2571, 0.2708])
        if args.multi_crop:
            ...
            augmentation1 = transforms.Compose([
                    ...
                    transforms.RandomApply([
                        transforms.ColorJitter(brightness=0.5, contrast=0.5, saturation=0.5, hue=0.1)  # not strengthened
                    ], p=0.8),
