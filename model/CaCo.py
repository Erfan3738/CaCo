...
class CaCo(nn.Module):
    ...
    def __init__(self, base_encoder,args, dim=128, m=0.99):
        ...
        self.encoder_q.fc = self._build_mlp(2,dim_mlp,args.mlp_dim,dim,last_bn=False ,use_split_bn=True, num_splits=8)
        self.encoder_k.fc = self._build_mlp(2,dim_mlp,args.mlp_dim,dim,last_bn=False, use_split_bn=True, num_splits=8)
